...
if not getgenv().Aimflux or getgenv().Aimflux.Aimbot then return end
...
local Environment = getgenv().Aimflux.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().Aimflux.Aimbot.Functions = nil
	getgenv().Aimflux.Aimbot = nil
